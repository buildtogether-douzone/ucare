...
public class DiagnosisController {
	...
	@PutMapping("/updateByDiagnosisNo")
	public ResponseEntity<?> updateByDiagnosisNo(@RequestBody DiagnosisVo data) {
		return new ResponseEntity<>(diagnosisService.updateByDiagnosisNo(data), HttpStatus.OK);
	}
}